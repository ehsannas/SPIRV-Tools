...
class IRContext {
 public:
  ...
  // index |index|. While the SPIR-V spec does not prohibit having multiple
  // OpMemberName instructions for the same structure member, it is hard to
  // imagine a member having more than one name. This method returns the first
  // one it finds.
